                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="company_post_vacancy.php" class="dropdown-item">Add Vacancy</a>
                            <a href="company_view_application.php" class="dropdown-item">View Applications</a>
                            <a href="company_assign_project.php" class="dropdown-item">Assign Project</a>
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 80px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="" class="h5 text-white">Company Tasks</a>
                </div>
            </div>
        </div>
    </div>
