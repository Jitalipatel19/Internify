...
if(mysqli_num_rows($res4)>0) {
    ...
    echo "<div class='container-fluid'>"; // Adjust the container size as per your requirement
    echo "<div class='table-responsive'>"; // Added to make the table scrollable on smaller screens
    echo "<table class='table table-bordered table-striped table-hover'>";
    echo "<thead class='thead-dark'>"; // Added to style the table header
    echo "<tr>
            <th>SID</th>
            <th>PROFILE</th>
            <th>NAME</th>
    ...
    while($r4=mysqli_fetch_array($res4)) {
        echo "<tr>";
        echo "<td>$r4[0]</td>";
        echo "<td><a href='$r4[1]' target='_blank'><img src='$r4[1]' class='rounded-circle img-thumbnail' style='width: 50px; height: 50px; object-fit: cover;'></a></td>"; // Modified to open image in new tab
        echo "<td>$r4[2]</td>";
        echo "<td>$r4[3]</td>";
        echo "<td>$r4[4]</td>";
        echo "<td>$r4[5]</td>";
        ...
        echo "<td>$r4[10]</td>";
        echo "<td>$r4[11]</td>";
        echo "<td><a href='admin_manage_student.php?action=edit&sid=$r4[0]' class='btn btn-primary'>EDIT</a></td>"; // Added button styling
        echo "<td><a href='admin_manage_student.php?action=delete&sid=$r4[0]' class='btn btn-danger'>DELETE</a></td>"; // Added button styling
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
    echo "</div>"; // Added to close the div
    echo "</div>"; // Added to close the container
} else {
