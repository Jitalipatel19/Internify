                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="admin_manage_student.php" class="dropdown-item">Manage Student</a>
                            <a href="admin_manage_faculty.php" class="dropdown-item">Manage Faculty</a>
                            <a href="admin_manage_prj_in.php" class="dropdown-item">Manage Projects</a>
                            <a href="admin_reports.php" class="dropdown-item">Reports</a>
                        </div>
                    </div>
